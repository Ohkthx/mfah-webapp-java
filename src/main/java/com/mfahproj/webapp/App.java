...
public class App {
    ...
    private static void setRoutes(HttpServer server, MiddlewareHandler.HttpRequestCallback callback) {
        ...
        // Deletes
        server.createContext("/artifact/delete", new MiddlewareHandler(new DeleteArtifactHandler(), callback));
        server.createContext("/artifactOwner/delete",
                new MiddlewareHandler(new DeleteArtifactOwnerHandler(), callback));
        ...
        server.createContext("/exhibition/delete", new MiddlewareHandler(new DeleteExhibitionHandler(), callback));
        server.createContext("/program/delete", new MiddlewareHandler(new DeleteProgramHandler(), callback));
